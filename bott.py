...
# ================= CONFIG =================
TOKEN = "8386952835:AAEJ8hXDq0NRUje_5eChujRZhBwz0Vw2CLI"  # inserisci il tuo token valido
...
def start(update, context):
    ...
    update.message.reply_text(
        ...
        "Usa /run ALL <comando> per eseguirlo su tutte le macchine.\n"
...
def run_command(update, context):
    ...
    # Esempio: avvia Locust in headless mode o altro comando specifico
    LAST_CMD = cmd
